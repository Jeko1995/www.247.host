...
public class CheckWithInvalidDataRegistrationPageFields47 extends TestUtil {

    // Test that check all fields negative validation on registration page
    @Test(dataProvider = "invalidRegistrationCredentials")
    public void checkWithInvalidDataRegistrationPageFields47(String firstAndLastName, String email, String password,
